...
class MappingSpecification(ConfiguredBaseModel):
    ...
    author: Optional[list[Union[Agent,Person,Organization,Software]]] = Field(default=None, description="""Author of the mapping specification""", json_schema_extra = { "linkml_meta": {'domain_of': ['MappingSpecification']} })
    creator: Optional[list[Union[Agent,Person,Organization,Software]]] = Field(default=None, description="""Creator of the mapping specification""", json_schema_extra = { "linkml_meta": {'domain_of': ['MappingSpecification']} })
    reviewer: Optional[list[Union[Agent,Person,Organization,Software]]] = Field(default=None, description="""Reviewer of the mapping specification""", json_schema_extra = { "linkml_meta": {'domain_of': ['MappingSpecification']} })
