# Contributing to fair-mappings-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
fair-mappings-schema. These guidelines are not strict rules.
...
The fair-mappings-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the fair-mappings-schema technical leads
...
[issues]: https://github.com/mapping-commons/fair-mappings-schema/issues/
[pulls]: https://github.com/mapping-commons/fair-mappings-schema/pulls/
